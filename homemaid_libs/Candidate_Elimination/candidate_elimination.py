from . import hipotesis
from .hipotesis import General, Especifica
import pandas as pd
from .procesamiento_datasets import valores_observados

def Candidate_Elimination(hipotesis_especificas:list[Especifica], hipotesis_generales:list[General], x_muestra:pd.DataFrame, y_muestra:pd.DataFrame, casos_positivos:dict[str, str] = {"positive":"1", "negative":"0"}):
